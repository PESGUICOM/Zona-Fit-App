...
public class ClienteDAO implements IClienteDAO {
    ...
    public List<Cliente> listarCliente() {
        ...
        try {
            ...
            rs = ps.executeQuery();
            while (rs.next()){ //Iterando para recuperar cada valor de cada columna
        ...
        return clientes; //para retornar la lista de clientes
    }
    ...
    public boolean agregarCliente(Cliente cliente) {
        ...
        try {
           ...
           ps.execute(); //para ejecutar nuestra sentencia
           return true;
        } catch (Exception e){
    ...
    public static void main(String[] args) {
        ...
        //Modificar cliente
        //var modificarCliente = new Cliente(8, "Rodrigo", "De Paul", 7);
        //var modificado = clienteDAO.modificarCliente(modificarCliente);
       // if (modificado)
       //     System.out.println("Cliente modificado: " + modificarCliente);
       // else
       //     System.out.println("No se modificó cliente: " + modificarCliente);
        ...
        //else
        //    System.out.println("No se eliminó cliente: " + clienteEliminar);
